/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d4cc2eee6955663590ee549276678eaf)
// Runtime types generated with workerd@1.20250803.0 2025-08-03
declare namespace Cloudflare {
	interface Env {
		DISCORD_CLIENT_ID: '1404871693767544893' | 'discord-client-id';
		DISCORD_GUILD_ID: '876131915424489472' | 'discord-guild-id';
		OIDC_CLIENT_ID: 'cloudflare-zero-trust' | 'oidc-client-id';
		CODE_PRIVATE_KEY: '{"kty":"EC","x":"VkG6BriibWKgOotuHfqVDz8rgkNqlsZCAH8A5Hq61W8","y":"_cG9tbtlt3UcTZgYOGS8YRhCPTvh1wDgIGtcgTna3R4","crv":"P-256","use":"enc","alg":"ECDH-ES+A256KW","kid":"0198a598-7251-70ad-a60b-c67111068eb2"}';

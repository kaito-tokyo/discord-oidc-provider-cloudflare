...
describe('/auth', () => {
	...
	const MOCK_OIDC_REDIRECT_URI = 'http://localhost/callback';
	...
	it('should redirect to Discord with valid parameters', async () => {
		const params = new URLSearchParams({
			...
			redirect_uri: MOCK_OIDC_REDIRECT_URI,
		...
		expect(redirectUrl.searchParams.get('client_id')).toBe(MOCK_DISCORD_CLIENT_ID);
